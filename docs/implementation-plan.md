...
- [ ] Firebase project exists with Auth enabled (email/password)
- [ ] `google-services.json` in Android project, app compiles with Firebase BOM
- [ ] Security rules deployed — authenticated user can only access own data
- [ ] Unauthenticated requests rejected
- [ ] Service account key generated for Pi dashboard
- [ ] Admin SDK reads work from a simple Kotlin JVM test program
- [ ] Composite indexes created for key queries
